    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('EditarLeadAdmin', ['id_lead'=> $lead->id_lead])}}">
                    @csrf
                    <div class="my-3">
                        <input type="text" class="form-control" placeholder="Nome:"
                               name="st_nome" aria-describedby="basic-addon1"
                               value="{{ old('st_nome') ? : $lead->st_nome}}">
                    ...
                    <div class="d-flex">
                        ...
                        <input type="text" class="form-control me-2" placeholder="E-mail:" name="st_email"
                               aria-describedby="basic-addon1" value="{{ old('st_email')?:$lead->st_email}}">
                        ...
                        <input type="text" class="form-control celular  w-75" placeholder="telefone:"
                               ...
                               value="{{ old('int_telefone') ?:$lead->int_telefone }}">
                    ...
                    <div class="d-flex justify-content-between my-2">
                        ...
                        <select class="form-select " name="int_temperatura" aria-label="Default select example">
                            ...
                            <option {{$lead->int_temperatura === 0 ? 'selected':''}} value="0">0%</option>
