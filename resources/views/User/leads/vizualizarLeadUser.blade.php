    ...
    <div class="">
        <div class="posicaoDiv w-100">
            ...
            <div class="container">
                ...
                <div>
                    <div class=" colorgray">
                        <a class="colorgrayLink" href="{{route('vizualizarTodasleadsUser')}}">Leads</a>
                        > detalhamento lead
                    </div>
                    ...
                    <div class="d-flex mt-5">
                        ...
                        @if($lead->bl_cliente === 0)
                            <a href="{{route('ConverterClienteUser',['id_lead'=>$lead->id_lead])}}" class="linksLeads me-3">Converter em cliente</a>
                        @endif
                    </div>
                    ...
                    <div class="modal fade" id="editarStatusOportunidade" data-bs-backdrop="static" data-bs-keyboard="false"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{route('editarStatusOportunidadeUser')}}">
                                        @csrf
